...
/**
 * File contains definition of class MoodleQuickForm_rubricrangeseditor
 *
...
class MoodleQuickForm_rubricrangeseditor extends HTML_QuickForm_input {
     ...
     *
     * @see gradingform_rubric_ranges_controller::update_or_check_rubric()
    ...
    public function toHtml() {
        global $PAGE;
        $html = $this->_getTabs();
        $renderer = $PAGE->get_renderer('gradingform_rubric_ranges');
    ...
    protected function prepare_data($value = null, $withvalidation = false) {
        ...
        $totalscore = 0;
        $errors = array();
        $return = array('criteria' => array(), 'options' => gradingform_rubric_ranges_controller::get_default_options());
        ...
        if ($withvalidation) {
            ...
            if (count($errors)) {
                ...
                foreach ($errors as $error => $v) {
                    $rv[] = get_string($error, 'gradingform_rubric_ranges');
                }
